...
DEFAULT_CONSENT_TEXT = """Согласие на обработку персональных данных

Оператор: Физическое лицо Хребтова Уйльвия Малих Гызы
Канал (Бот): https://t.me/igrok_reality_bot

Настоящим я, субъект персональных данных, действуя свободно, своей волей и в своем интересе, даю конкретное, предметное, информированное и сознательное согласие на обработку моих персональных данных на следующих условиях:
...
• Идентификация Пользователя для предоставления доступа к закрытому (платному) контенту бота;
• Заключение и исполнение договора (публичной оферты) на оказание информационных услуг;
• Связь с Пользователем (уведомления о статусе подписки, техническая поддержка);
• Формирование и отправка отчетных документов (чеков), если это применимо.
...
4. Способы обработки:
Обработка осуществляется как с использованием средств автоматизации (информационные системы, боты, базы данных), так и без использования таких средств.

5. Трансграничная передача:
Я уведомлен(а) и согласен(на), что обработка данных осуществляется с использованием мессенджера Telegram. Оператор предупреждает, что серверы Telegram могут находиться за пределами территории Российской Федерации. Я даю согласие на трансграничную передачу моих персональных данных в целях обеспечения функционирования бота и предоставления мне доступа к услугам.

6. Срок действия согласия и порядок отзыва:
Согласие действует до достижения целей обработки либо до момента его отзыва. Согласие может быть отозвано мной в любой момент путем направления письменного уведомления Оператору через функционал бота (кнопка «Поддержка») или на контактный адрес электронной почты Оператора (если указан). В случае отзыва согласия Оператор обязан прекратить обработку данных и уничтожить их в срок, не превышающий 30 дней с момента поступления отзыва, за исключением случаев, когда обработка должна быть продолжена в соответствии с законодательством РФ.

7. Подтверждение:
Я подтверждаю, что мне разъяснены юридические последствия отказа от предоставления согласия, а также то, что настоящее согласие оформляется отдельно от иных документов (Политики конфиденциальности, Оферты).
